...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="{{url('http://localhost:8000/home')}}"><span class="text-primary">One</span>-Health</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="{{url('http://localhost:8000/home')}}">Home</a>
            </li>
            <li class="nav-item">
